...
class TrendyShoes extends StatefulWidget {
  @override
  _TrendyShoesState createState() => _TrendyShoesState();
}

class _TrendyShoesState extends State<TrendyShoes> {
  ...
  Widget buildProducts(BuildContext context, int index, DocumentSnapshot document){
    ...
    print("yipeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
          ...
          children: [
            ...
            new Container(
                ...
                child :IconButton(
                    ...
                    onPressed: () {
                      Firestore.instance.collection('shoes').doc('8TxVgse5EEs92GmUIBO1').delete();
                      FirebaseStorage.instance.refFromURL('gs://ecommerce-4b036.appspot.com/shoes/8TxVgse5EEs92GmUIBO1').delete();
                    })
            ),
            // ],
            // ),
