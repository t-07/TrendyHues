...
class TrendyPants extends StatefulWidget {
  @override
  _TrendyPantsState createState() => _TrendyPantsState();
}

class _TrendyPantsState extends State<TrendyPants> {
        ...
        child: Column(
            children: [
              StreamBuilder<QuerySnapshot>(
                  stream: Firestore.instance.collection(pants).snapshots(),
          ...
          children: [
            ...
            new Container(
                ...
                child :IconButton(
                    ...
                    onPressed: () {
                      Firestore.instance.collection('pants').doc('69NX7MtKfsvgi58iTcV5').delete();
                      FirebaseStorage.instance.refFromURL('gs://ecommerce-4b036.appspot.com/pants/69NX7MtKfsvgi58iTcV5').delete();
                    })
            ),
            // ],
            // ),
