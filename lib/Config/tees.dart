...
class TrendyTees extends StatefulWidget {
  @override
  _TrendyTeesState createState() => _TrendyTeesState();
}

class _TrendyTeesState extends State<TrendyTees> {
        ...
        child: Column(
            children: [
              StreamBuilder<QuerySnapshot>(
                  stream: Firestore.instance.collection(tees).snapshots(),
          ...
          children: [
            ...
            new Container(
                ...
                child :IconButton(
                    ...
                    onPressed: () {
                      Firestore.instance.collection('tees').doc('I4seDdPFaTm2ajdhgnFb').delete();
                      FirebaseStorage.instance.refFromURL('gs://ecommerce-4b036.appspot.com/tees/I4seDdPFaTm2ajdhgnFb').delete();
                    })
            ),
            // ],
            // ),
