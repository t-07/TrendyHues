...
class TrendyJeans extends StatefulWidget {
  @override
  _TrendyJeansState createState() => _TrendyJeansState();
}

class _TrendyJeansState extends State<TrendyJeans> {
          ...
          children: [
            ...
            new Container(
                ...
                child :IconButton(
                    ...
                    onPressed: () {
                      Firestore.instance.collection('jeans').doc('1GMRXFZZf5RHfwpYAWIG').delete();
                      FirebaseStorage.instance.refFromURL('gs://ecommerce-4b036.appspot.com/jeans/1GMRXFZZf5RHfwpYAWIG').delete();
                    })
            ),
            // ],
            // ),
