...
class TrendyFootwear extends StatefulWidget {
  @override
  _TrendyFootwearState createState() => _TrendyFootwearState();
}

class _TrendyFootwearState extends State<TrendyFootwear> {
        ...
        child: Column(
            children: [
              StreamBuilder<QuerySnapshot>(
                  stream: Firestore.instance.collection(footwear).snapshots(),
          ...
          children: [
            ...
            new Container(
                ...
                child :IconButton(
                    ...
                    onPressed: () {
                      Firestore.instance.collection('footwear').doc('2CiawLvol5GKRmsBpGbj').delete();
                      FirebaseStorage.instance.refFromURL('gs://ecommerce-4b036.appspot.com/footwear/2CiawLvol5GKRmsBpGbj').delete();
                    })
            ),
            // ],
            // ),
