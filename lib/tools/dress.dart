...
class TrendyDress extends StatefulWidget {
  @override
  _TrendyDressState createState() => _TrendyDressState();
}

class _TrendyDressState extends State<TrendyDress> {
                ...
                child: Row(
                  ...
                  children: [
                    Wrap(
                      ...
                      children: [new Text("${document[productTitle]}         ",
